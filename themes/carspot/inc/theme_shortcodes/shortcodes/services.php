...
/* Services */ 
/* ------------------------------------------------ */
if (!function_exists('services_short')) {
function services_short()
{
	vc_map(array(
		"name" => esc_html__("Services", 'carspot') ,
		"base" => "services_short_base",
...
add_action('vc_before_init', 'services_short');
if (!function_exists('services_short_base_func')) {
function services_short_base_func($atts, $content = '')
{
require trailingslashit( get_template_directory () ) . "inc/theme_shortcodes/shortcodes/layouts/header_layout.php";
	...
	return '<section class="section-padding services-center '.$parallex.' '.$bg_color.' '.$top_padding.'" ' . $style .' >
            <div class="container">
			   '.$header.'
...
{
	carspot_add_code('services_short_base', 'services_short_base_func');
}