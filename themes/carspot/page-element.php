            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 margin-bottom-40">
                     ...
                     <button class="btn btn-blue"><i class="fa fa-circle-o-notch fa-spin"></i> Loading</button>
                     <button class="btn btn-danger"><i class="fa fa-refresh fa-spin"></i> Loading</button>
                     <button class="btn btn-info"><i class="fa fa-spinner fa-spin"></i> Loading</button>
                  </div>
               </div>
               <!-- =-=-=-=-=-=-= Buttons =-=-=-=-=-=-= -->
               <div class="row">
