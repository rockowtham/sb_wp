...
<div class="colored-header">
    ...
    <?php
    $make_relative = '';
    if (isset($carspot_theme['sb_header']) == "transparent" && is_singular('ad_post') && $carspot_theme['single_ad_style'] == "2") {
        $make_relative = 'make-relative';
    }
    $register_process = isset($carspot_theme['cs_register_proces']) ? $carspot_theme['cs_register_proces'] : true;
    ?>
    <!-- menu start -->
    <nav id="menu-1" class="mega-menu header-transparent <?php echo carspot_returnEcho($make_relative); ?>">
