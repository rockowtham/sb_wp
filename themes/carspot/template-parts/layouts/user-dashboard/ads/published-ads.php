...
<div class="panel-heading">
    ...
    <form class="form form-inline form-published-search" method="get">
        <div class="form-group">
            <input type="text" class="form-control" name="search_title" value="<?php echo esc_attr($title);?>" placeholder="<?php echo esc_html__( 'Search Inventory', 'carspot' ) ?>">
                                                ...
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="javascript:void(0);"> <i class="la la-times-circle-o"></i> <?php echo esc_attr__( 'Mark Expired', 'carspot' ) ?></a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:void(0);" class="ad_status"> <i class="la la-power-off"></i> <?php echo esc_attr__( 'Mark Sold', 'carspot' ) ?></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
										...
										?>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu ad_status_new">
                                                    <li data-val="expired"  data-adid="<?php echo esc_attr($pid); ?>">
                                                        <a href="javascript:void(0);"> <i class="la la-times-circle-o"></i> <?php echo esc_attr__( 'Mark Expired', 'carspot' ) ?></a>
                                                    </li>
                                                    <li data-val="sold"  data-adid="<?php echo esc_attr($pid); ?>">
                                                        <a href="javascript:void(0);" class="ad_status" data-adid="<?php echo esc_attr($pid); ?>" disabled> <i class="la la-power-off"></i> <?php echo esc_attr__( 'Mark Sold', 'carspot' ) ?></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
