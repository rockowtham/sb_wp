...
$args = array(
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Languag and Color', 'carspot-rest-api' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Nearby and Location', 'carspot-rest-api' ),
        'id'         => 'app_settings_nearby_location',
        'desc'       => '',
		'subsection' => true,
        'fields'     => array(	
			...
			array(
				...
				'default'  => 'cities',
				'desc'     => __( 'Settings for the google location search', 'carspot-rest-api' ),	
			),		
			array(
                'id'       => 'allow_near_by',
                'type'     => 'switch',
         ...
         array(
          ...
          array(
			...
			array(
                ...
                'type'     => 'switch',
                'title'    => __( 'Show Page', "carspot-rest-api" ),
				'desc'     => __( 'Show app share icon on the top.', "carspot-rest-api" ),
                'default'  => true,
            ),		
			   array(
